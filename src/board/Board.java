...
public final class Board implements Drawable{
    ...
    public void setMap (){
        ...
        setShip(new Cruiser(true, map[8][2]));
        setShip(new Carrier(true, map[8][3]));
        setShip(new Cruiser(true, map[8][4]));
        setShip(new Fighter(true, map[7][2]));
        setShip(new Fighter(true, map[7][3]));
        setShip(new Fighter(true, map[7][4]));
    }
